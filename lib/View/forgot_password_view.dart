...
import 'package:app3/Utilities/dialogs/password_reset_email_sent_dialog.dart';
          ...
          if (state is AuthStateForgotPassword) {
            ...
            if (state.exception != null) {
              await showErrorDialog(context,
                  'We could not process your request. Please make sure your a registered user');
            }
          }
        },
        child: Scaffold(
            ...
            body: Padding(
              ...
              child: Column(children: [
                const Text('Enter your email here to reset your password'),
                TextField(
